...
MODx.load({
    ...
    ,items: [{
        ...
        xtype: 'combo-boolean'
        ,fieldLabel: 'width-fix'
        ,description: 'Fix column width'
        ,name: 'inopt_widthfix'
        ,hiddenName: 'inopt_widthfix'
        ,id: 'inopt_widthfix{/literal}{$tv}{literal}'
        ,value: params['widthfix'] == 'true' || params['widthfix'] == 'false' ? 0 : 1
        ,width: 200
        ,listeners: oc
    },{
        xtype: MODx.expandHelp ? 'label' : 'hidden'
        ,forId: 'inopt_widthfix{/literal}{$tv}{literal}'
        ,html: 'Fix column width. Code here: /manager/templates/default/element/tv/renders/input/taxonomytv.tpl Line 116'
        ,cls: 'desc-under'
    }]
